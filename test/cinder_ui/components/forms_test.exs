defmodule CinderUI.Components.FormsTest do
  ...
  test "field family structural components render semantic wrappers" do
    field_set_html =
      render_component(&Forms.field_set/1, %{
        inner_block: TestHelpers.slot("Billing")
      })

    field_group_html =
      render_component(&Forms.field_group/1, %{
        inner_block: TestHelpers.slot("Fields")
      })

    legend_html =
      render_component(&Forms.field_legend/1, %{
        variant: :label,
        inner_block: TestHelpers.slot("Preferences")
      })

    content_html =
      render_component(&Forms.field_content/1, %{
        inner_block: TestHelpers.slot("Content")
      })

    title_html =
      render_component(&Forms.field_title/1, %{
  ...
  test "field_separator renders plain and labeled dividers" do
    plain_html = render_component(&Forms.field_separator/1, %{})

    labeled_html =
      render_component(&Forms.field_separator/1, %{
